...
const About = () => {
  ...
  const hasContact = contact.whatsapp || contact.instagramUrl;
  return (
  <>
    <main className="about">
      ...
      {hasContact && <div className="about__contact" aria-label="Opciones de contacto">
        {contact.whatsapp && <a className="about__contact-card about__contact-card--whatsapp" href={`https://wa.me/${contact.whatsapp}`} target="_blank" rel="noopener noreferrer">
          <span className="about__contact-icon"><WhatsAppIcon /></span>
          <span className="about__contact-copy"><strong>WhatsApp</strong><span>Pregúntanos por un producto</span><small>{contact.whatsappDisplay}</small></span>
        </a>}
        {contact.instagramUrl && <a className="about__contact-card about__contact-card--instagram" href={contact.instagramUrl} target="_blank" rel="noopener noreferrer">
          <span className="about__contact-icon"><InstagramIcon /></span>
          <span className="about__contact-copy"><strong>Instagram</strong><span>{contact.instagramHandle}</span></span>
        </a>}
      </div>}
    </main>
    <Footer />
